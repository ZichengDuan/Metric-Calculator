...
def APAOS_calculator(gt, det, thresh):
    F = int(max(gt[:, 0])) + 1
    # F = 1
    precs = 0
    aos = 0
...
def evaluateDetectionAPAOS(res_fpath, gt_fpath):
    ...
    AP_50, AOS_50 = APAOS_calculator(gtAllMatrix, detAllMatrix, 0.5)
    AP_25, AOS_25 = APAOS_calculator(gtAllMatrix, detAllMatrix, 0.25)
